...
Phase 12 foi implementada fora da ordem planejada. Ainda falta validação manual com uma
conta Google real após configurar `GOOGLE_CLIENT_ID`, `GOOGLE_CLIENT_SECRET`,
